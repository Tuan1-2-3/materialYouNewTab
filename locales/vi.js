...
const vi = {
    ...
    // "googleAppsHover": "Ứng dụng Google",  // Keep this shorter

    // Todo List
    // "todoListText": "Danh sách việc cần làm",
    // "todoListInfo": "Hiển thị danh sách việc cần làm hàng ngày",
    // "todoListHover": "Việc cần làm",    // Keep this short
    ...
    // "bookmarkViewGrid": "Lưới",    // Keep this shorter
    // "bookmarkViewList": "Danh sách",    // Keep this shorter
    ...
    // "uploadWallpaperText": "Tải hình nền",    // Keep this short
    // "backupText": "Sao lưu",
    // "restoreText": "Khôi phục",
    // "rangColor": "Chọn màu",    // Keep this short
    ...
    // "UnsupportedBrowser": "Trình duyệt của bạn không hỗ trợ dấu trang",
};
